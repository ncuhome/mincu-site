...
好的方案需要好的工具去落地，那么该如何去落地 Monorepo 方案呢？在社区里，我们能找到许多类似的工具。<br />比如 [lerna](https://github.com/lerna/lerna) / [bolt](https://github.com/boltpkg/bolt) / [preconstruct](https://github.com/preconstruct/preconstruct) 等，mincu 使用 preconstruct 作为 monorepo 方案开发工具
