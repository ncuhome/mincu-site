...
根据上述 API，我们采用了以下的通信能力解决方案:<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/190122/1639637782830-4a886a87-917c-442c-8575-01086df0802f.png#clientId=uabc01c1b-0ac6-4&crop=0&crop=0&crop=1&crop=1&from=paste&height=199&id=wrrml&margin=%5Bobject%20Object%5D&name=image.png&originHeight=584&originWidth=1628&originalType=binary&ratio=1&rotation=0&showTitle=false&size=225457&status=done&style=none&taskId=u4b7e8720-d747-4469-a16a-276f60645b2&title=&width=555)
...
下面流程图，即当用户通过南大家园打开使用了 mincu 的应用并进入应用页面时所发生的所有事情：<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/190122/1639722852621-bb222897-e552-43b3-8f79-6995017faf47.png#clientId=uabc01c1b-0ac6-4&crop=0&crop=0&crop=1&crop=1&from=paste&height=322&id=ufa90f6f6&margin=%5Bobject%20Object%5D&name=image.png&originHeight=1200&originWidth=2588&originalType=binary&ratio=1&rotation=0&showTitle=false&size=700134&status=done&style=none&taskId=u8dec10f9-8dc6-420b-921a-01079edc6f0&title=&width=695)

## 🚥 一般情景的调用链路

这里我们已经通过轮询的方式进入了 mincu 环境了，但如何在 mincu 环境下调用原生 API 并获得它的返回值呢？我们给出了如下的方案。<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/190122/1639637986869-dbe94739-79da-4b1a-a75c-0c5eaf36713e.png#clientId=uabc01c1b-0ac6-4&crop=0&crop=0&crop=1&crop=1&from=paste&height=575&id=u1f4fe933&margin=%5Bobject%20Object%5D&name=image.png&originHeight=1150&originWidth=1118&originalType=binary&ratio=1&rotation=0&showTitle=false&size=455275&status=done&style=none&taskId=u39be9b14-92ac-4c16-9f8a-cfb85a90ce0&title=&width=559)
...
具体注入方法请查看：[https://github.com/ncuhome/iNCU/blob/dev/patches/react-native-webview%2B11.14.0.patch](https://github.com/ncuhome/iNCU/blob/dev/patches/react-native-webview%2B11.14.0.patch)
...
白名单系统会默认放行 *.ncuos.com 的域名进入 mincu 环境中，其他域名都不会被注入 mincu runtime。<br />![image.png](https://cdn.nlark.com/yuque/0/2021/png/190122/1639848493287-da678b02-f090-43d0-bd73-d06dc83946df.png#clientId=ud526331a-b4df-4&crop=0&crop=0&crop=1&crop=1&from=paste&height=397&id=u5e55a64f&margin=%5Bobject%20Object%5D&name=image.png&originHeight=1234&originWidth=1270&originalType=binary&ratio=1&rotation=0&showTitle=false&size=490835&status=done&style=none&taskId=u7bd79fe2-e4bc-4875-ab45-a14a98bd068&title=&width=409)
